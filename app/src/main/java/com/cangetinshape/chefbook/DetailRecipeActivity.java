...
public class DetailRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdView = (AdView) findViewById(R.id.ad_view_detail);
        mAdView.setAdListener(new ToastAdListener(this));
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        titleTV = (TextView)findViewById(R.id.title_tv);
        TextView categoryTV = (TextView)findViewById(R.id.category_tv_toshow);
        TextView creatorTV = (TextView)findViewById(R.id.added_by_tv);

        mainImageView = (ImageView)findViewById(R.id.main_iv);
        secondImageView = (ImageView)findViewById(R.id.second_iv);
        thirdImageView = (ImageView)findViewById(R.id.third_iv);
        forthImageView = (ImageView)findViewById(R.id.forth_iv);

        TextView servingsTV = (TextView)findViewById(R.id.recipe_serving_tv);
        ...
        if (mCurrentBestRecipe!=null) {
            ...
            if(mUser!=null){creatorTV.setText(mUser.getDisplayName());}
            ...
            ListView ingredientListView = (ListView)findViewById(R.id.ingredient_lv);
            ...
            ListView stepListView = (ListView)findViewById(R.id.steps_lv);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_share){
            startActivity(Intent.createChooser(ShareCompat.IntentBuilder.from(this)
                    .setType("text/plain")
                    .setText("Please download ChefBook to share our recipes, from https://play.google.com/store/apps ")
        ...
        if(id==R.id.action_save_online){
            ...
            if(mCurrentBestRecipe.getImages().size() > 0 ) {
                ...
                Toast.makeText(this,"Your recipe has saved to the ChefBook DataBase!",Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(this,"Your recipe with no Image has saved to the ChefBook DataBase!",Toast.LENGTH_SHORT).show();
                ...
                .setPositiveButton(getString(R.string.delete_text), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        try {
                            ...
                            if(numberOfRows == 1){
                                Toast.makeText(DetailRecipeActivity.this,"You have deleted the "  + titleTV.getText()+ " recipe!",Toast.LENGTH_LONG).show();
                                finish();
                            }
                        } catch (Exception e) {
